...
//	olderThan = flag.Duration("older_than", 0, "Filter to use when listing deploys.")
...
//	if err != nil {
//		log.WithError(err).Fatal("Failed to list deploys")
//	}
//
//	for {
//		user, err := srv.Recv()
...
//				break
//			}
//			log.WithError(err).Fatal("Error while receiving deploys")
//		}
//
//		log.WithFields(logrus.Fields{
//			"id":          user.GetId(),
