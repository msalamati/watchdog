...
import (
	...
	"github.com/msalamati/watchdog/deploys"
...
func main() {
	...
	var dir deployspb.DeployServiceServer
	dir, err = deploys.NewDirectory(log, parsedURL)
	if err != nil {
		log.WithError(err).Fatal("Failed to create user directory")
	}
	deployspb.RegisterDeployServiceServer(s, dir)
